...
**Z-Organizer** is a smart, cross-platform file manager developed in Python. It helps you declutter and organize messy folders and subfolders in seconds, using an advanced hybrid rule engine and automated classification.
