...
### 🇧🇷 For Brazilian Supporters (Pix / Nubank)
You can support the project directly via Pix. Just scan the QR Code below using your bank's app:
...
*(Add your Buy Me a Coffee, Ko-fi, or PayPal links here in the future)*

---
**Thank you for using and supporting CopynDown!** 🚀
