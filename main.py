...
class FileOrganizerApp(ctk.CTk):
    ...
    def build_ui(self):
        ...
        self.lbl_s1 = ctk.CTkLabel(top_frame, text="", font=("Segoe UI", 14, "bold"), text_color=TEXT_MAIN)
        ...
        self.lbl_s2 = ctk.CTkLabel(auto_frame, text="", font=("Segoe UI", 14, "bold"), text_color=TEXT_MAIN)
        ...
        self.lbl_s3 = ctk.CTkLabel(header_rules_frame, text="", font=("Segoe UI", 14, "bold"), text_color=TEXT_MAIN)
        self.lbl_s3.pack(side="left")
        
        self.btn_add_rule = ctk.CTkButton(header_rules_frame, text="", width=100, height=30, corner_radius=8, fg_color=BG_INPUT, text_color=TEXT_MAIN, hover_color=COLOR_BORDER, command=self.add_rule_row)
    ...
    def add_rule_row(self):
        ...
        attr_menu = ctk.CTkOptionMenu(rule_frame, values=list(opts.values()), variable=attr_var, command=on_option_change, width=260, fg_color=BG_INPUT, text_color=TEXT_MAIN, button_color=BG_INPUT)
